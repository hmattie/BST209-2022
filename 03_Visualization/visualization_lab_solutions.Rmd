...
georgia_counties_may9 %>% 
  ...
  ggtitle("Distribution of county cases") + 
  xlab("Cases") + 
...
georgia_counties_apr26_may9 <- georgia_counties %>% 
  filter(date >= as.Date("2020-04-26") & date <= as.Date("2020-05-09"))
head(georgia_counties_apr26_may9)
```
...
georgia5_apr26_may9 %>% 
  ...
  geom_bar(aes(group = county), position = position_dodge(), color = "black") + 
  xlab("Date") + 
  ylab("New Cases") + 
